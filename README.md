...
type (few last numbers may be reserved for special purposes). The reason is
that inoptimal data structures (bitsets) would be too large and slow if they
had 65536 bits.
...
YaLe parses HTTP headers at a rate of 8.3 gigabits per seconds on a modern
