...
static inline int yale_ffsu32(uint32_t v)
{
  ...
  r = MultiplyDeBruijnBitPosition[((uint32_t)((v & (~v+1)) * 0x077CB531U)) >> 27];
  return v?(r+1):0;
}
static inline int yale_ffsu16(uint16_t v)
{
  ...
  r = MultiplyDeBruijnBitPosition[((uint16_t)((v & (~v+1)) * 0x09af)) >> 12];
  return v?(r+1):0;
}
static inline int yale_ffsu8(uint8_t v)
{
  ...
  r = MultiplyDeBruijnBitPosition[((uint8_t)((v & (~v+1)) * 0x1d)) >> 5];
  return v?(r+1):0;
}
#endif
...
static inline int yale_ffsu64(uint64_t x)
{
  ...
  r = MultiplyDeBruijnBitPosition[((uint64_t)((v & (~v+1)) * 0x022fdd63cc95386dULL)) >> 58];
  return v?(r+1):0;
#endif
#endif
#endif
